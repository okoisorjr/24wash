  ...
  return (
    ...
    {/*   <div className="z-10 max-w-5xl w-full items-center justify-between font-mono text-sm lg:flex">
      ...
      <div className='text-center'>
        <p className='text-2xl md:text-3xl lg:text-5xl font-extrabold bg-gradient-to-r from-[#FDC48F] to-[#6540DD] text-transparent bg-clip-text'>Professional Cleaning<br/><span>Service at your Convenience.</span></p><br/>
        <span className='text-sm lg:text-lg'>Experience Seamless Laundry Excellence Tailored to Your Schedule. We Pick and <br/>deliver every Saturdays and Sundays.</span>
      </div>
      ...
      <div className='flex flex-col'>
        <p className='text-2xl md:text-3xl lg:text-5xl text-center font-extrabold text-[#6540DD]'>Our Services</p>
        <span className='text-lg md:text-xl lg:text-xl text-center font-extralight'>Why choose us</span>
      </div>
      ...
      <div className='flex flex-col'>
        <p className='text-2xl md:text-3xl lg:text-5xl text-center font-extrabold text-[#6540DD] my-5'>Subscription Plan</p><br/>
        <span className='text-sm md:text-xl lg:text-xl text-center font-extralight'>Affordable Rates for High-Quality Services. </span>
      </div>
